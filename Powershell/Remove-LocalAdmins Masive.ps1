...
$Log = "m:\powershell\Remove-LocalAdmins Masive-" + $Date + "-" + $Hour + "-" + $Minuntes + ".log" 
 
#Creates a log file for this process 
Start-Transcript -Path $Log  -Force  
 
#List of computers to be check 
$ComputerNames = Get-Content "m:\powershell\Removeadminservers.txt" 
...
$Admins = Get-Content "m:\powershell\RemoveadminUsers.txt" 
