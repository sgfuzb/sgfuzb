...
psexec \\%1 c:\iperf3.exe -c %2 
rem psexec \\%1 c:\iperf3.exe -c %2 -t 10 -i 10 -w 512K -P 5

psexec -d \\%1 c:\iperf3.exe -s -1
psexec \\%2 c:\iperf3.exe -c %1 
rem psexec \\%2 c:\iperf3.exe -c %1 -t 10 -i 10 -w 512K -P 5
